...
- **E** informa "Quadra não encontrada."
...
- **E** informa "Número de contrato já cadastrado."
...
- **ENTAO** o sistema rejeita a operacao
- **E** informa "A sepultura selecionada não pode ser vinculada a contratos."
...
- **ENTAO** o sistema rejeita a operacao
- **E** informa "Esta sepultura já possui um contrato ativo."
