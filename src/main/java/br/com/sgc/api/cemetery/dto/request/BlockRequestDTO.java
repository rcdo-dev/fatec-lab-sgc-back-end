...
public record BlockRequestDTO(
                ...
                @Schema(description = "Número da quadra.", example = "12") @Positive int number,
                ...
                @Schema(description = "ID do cemitério em que a quadra está vinculada.", example = "1") @NotNull @Positive Long cemeteryId) {
}
