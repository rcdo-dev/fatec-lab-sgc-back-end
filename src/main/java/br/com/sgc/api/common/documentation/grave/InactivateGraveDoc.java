...
@Operation(summary = "Inativar sepultura.")
@ApiResponses(value = {
    @ApiResponse(
        responseCode = "200",
        description = "Sepultura inativada com sucesso.",
        content = @Content(
            mediaType = MediaType.APPLICATION_JSON_VALUE,
            schema = @Schema(implementation = GraveResponseDTO.class),
            examples = @ExampleObject(
                name = "Sepultura inativada",
                value = """
                        {
                            "id": 1,
                            "number": 127,
                            ...
                            "status": "OCCUPIED",
                            "blocked": true,
                            "reason": "Processo jurídico aguardando resposta.",
                            "blockId": 1,
                            "active": false
                        }
                        """
...
public @interface InactivateGraveDoc {
